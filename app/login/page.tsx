...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-none border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold uppercase tracking-tight text-black">Admin Login</h1>
          <p className="text-neutral-600 font-bold uppercase tracking-widest text-xs mt-2">Dave Flew Automotive</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-neutral-50 border-2 border-black rounded-none focus:bg-white focus:ring-0 focus:outline-none transition-colors shadow-inner text-black font-medium"
            />
          </div>
