  ...
  if (success) {
    return (
      <div className="p-8 text-center bg-white border-2 border-green-500 shadow-[4px_4px_0px_0px_rgba(34,197,94,0.2)] rounded-none transition-all duration-300 ease-in-out relative">
        ...
        <h3 className="text-2xl font-black text-slate-900 mb-2 uppercase tracking-tight">Booking Request Sent</h3>
        <p className="text-slate-600 font-medium">Thanks, Dave will confirm your slot shortly.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label htmlFor="customer_name" className="block text-sm font-bold text-slate-900 mb-2 uppercase tracking-wide">
            Full Name
          </label>
          <input
            type="text"
            ...
            autoComplete="name"
            maxLength={100}
            className="w-full px-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-none focus:bg-white focus:ring-0 focus:border-red-600 outline-none transition-colors shadow-inner text-slate-900 font-medium peer"
        ...
        <div>
          <label htmlFor="customer_phone" className="block text-sm font-bold text-slate-900 mb-2 uppercase tracking-wide">
            Phone Number
          </label>
          <input
            type="tel"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="group">
          ...
          <DatePicker
            ...
            calendarStartDay={1}
            className="w-full px-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-none focus:bg-white focus:ring-0 focus:border-red-600 outline-none transition-colors shadow-inner text-slate-900 font-medium"
      ...
      <div>
        <label htmlFor="problem_description" className="block text-sm font-bold text-slate-900 mb-2 uppercase tracking-wide">
          Problem Description
        </label>
        <textarea
          ...
          maxLength={1000}
          rows={4}
          className="w-full px-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-none focus:bg-white focus:ring-0 focus:border-red-600 outline-none transition-colors shadow-inner resize-none text-slate-900 font-medium peer"
